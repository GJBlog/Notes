...
一、当前激活成功的版本对应是2022.2.2版本，需要的文件如下

1、补丁文件：

```
路径： /Users/guojie/crack/2022-9-17-version/ja-netfilter/ja-netfilter.jar
```
...
1、不同的激活码只能对应某一个App，补丁文件也许可以通用

2、[地址](https://www.exception.site/essay/idea-reset-eval)